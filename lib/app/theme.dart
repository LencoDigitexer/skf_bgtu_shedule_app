...
class AppTheme {
  ...
  ThemeData get darkTheme => _darkBase.copyWith(
        ...
        cardTheme: _darkBase.cardTheme.copyWith(
          color: AppColors.dark, // Set the background color of Card to black
        ),
  ...
  ThemeData get lightTheme => _lightBase.copyWith(
        ...
        cardTheme: CardTheme(
          color: AppColors.light, // Set the background color of Card to black
        ),
